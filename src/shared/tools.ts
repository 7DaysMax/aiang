  ...
  switch (toolName) {
    ...
    case "TaskOutput":
      return {
        ...
        toolId,
        input: {
          taskId: typeof input.task_id === "string" ? input.task_id : "",
    ...
    case "CronDelete":
      return {
        kind: "tool",
        toolKind: "cron_delete",
        toolName,
        toolId,
        input: {
          cronId: typeof input.cron_id === "string" ? input.cron_id : "",
        },
        rawInput: input,
      }
    case "CronList":
    ...
    case "KillShell":
      return {
        ...
        toolId,
        input: {
          signal: typeof input.signal === "number" ? input.signal : undefined,
        },
        rawInput: input,
      }
    case "EnterPlanMode":
    ...
    case "NotebookEdit":
      return {
        ...
        toolId,
        input: {
          notebookPath: typeof input.notebook_path === "string" ? input.notebook_path : undefined,
          cellId: typeof input.cell_id === "string" ? input.cell_id : undefined,
          newSource: typeof input.new_source === "string" ? input.new_source : undefined,
        },
        rawInput: input,
      }
  }
