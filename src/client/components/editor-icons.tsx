...
const ICON_SRC: Record<"cursor" | "vscode" | "finder" | "preview" | "defaultApp" | "xcode" | "terminal" | "windsurf" | "custom", string> = {
...
export function EditorIcon({ preset, className }: { preset: EditorPreset; className?: string }) {
  switch (preset) {
    case "vscode":
      return <AppIcon src={ICON_SRC.vscode} className={className} />
    case "xcode":
