...
export default function LoadingState({
  ...
  if (surfer) {
    return (
      <div data-beautifului="loading-state" data-variant={variant} role="status" className="flex w-fit flex-col items-start">
  ...
  return (
    <div data-beautifului="loading-state" data-variant={variant} role="status" className="flex w-fit items-center gap-2.5">
