...
export default function FineTuneCard({
  ...
  const [typeValue, setTypeValue] = useState(initialType ?? text.placeholder);
  ...
  return (
    <div data-beautifului="fine-tune-card" className="relative w-full max-w-60 rounded-card bg-surface shadow-raised">
      {/* header */}
