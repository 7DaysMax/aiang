...
/** Production shell shared by the live transcript and composer dock. */
export function ChatSurface({ children, className = "" }: { children: ReactNode; className?: string }) {
  return <div data-beautifului="chat" className={className}>{children}</div>;
}
