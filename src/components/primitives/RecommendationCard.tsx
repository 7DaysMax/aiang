...
export default function RecommendationCard({
  ...
  return (
    <div data-beautifului="recommendation-card" className="w-full max-w-95 overflow-hidden rounded-card bg-surface shadow-card">
      ...
      <div className="primitive-card-footer flex items-center justify-between gap-3 bg-surface">
        ...
        <span className="-mr-0.5 flex items-center gap-2">
          ...
          <Button
            ...
            size="sm"
            onClick={() => { setAccepted(true); onAccept?.(active); }}
