...
describe("parseCursorLine", () => {
  ...
  test("prompt echo, empty thinking, and malformed lines produce no entries", () => {
  ...
  test("thinking deltas become thinking transcript entries", () => {
    expect(firstEntry(`{"type":"thinking","subtype":"delta","text":"Let me reason"}`)).toMatchObject({
      kind: "thinking",
      text: "Let me reason",
    })
  })
